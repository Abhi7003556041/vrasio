...
const PaymentBottomSheet = (props) => {
    ...
    const paymentTypeList=[{id:0,name:"PayPal",icon:AllSourcePath.LOCAL_IMAGES.PayPal},{id:1,name:"Apple Pay",icon:AllSourcePath.LOCAL_IMAGES.ApplePay}]
    ...
    return (
        ...
        visible={true}
        >
            <Pressable style={{flex:1/2}} onPress={()=>props.onBackgroundPress?props.onBackgroundPress:setIsVisible(false)}>
                {props.children}
            </Pressable>
            <View style={{flex:1/2,backgroundColor:'#f4f4f4',borderTopEndRadius:30,borderTopStartRadius:30}}>
