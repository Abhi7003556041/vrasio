...
class BottomSheet extends Component {
  ...
  _setPanResponders() {
    ...
    this._childPanResponder = PanResponder.create({
      ...
      onPanResponderMove:(_,gestureState) =>Platform.OS==='ios' ? gestureState.dy > 90 && this.props.func(true) : gestureState.dy > 15 && this.props.func(true),
       onMoveShouldSetPanResponderCapture: (_, gestureState) =>
       Platform.OS==='ios' ?  gestureState.dy > 90 : gestureState.dy > 15  ,
      onPanResponderRelease: (_, gestureState) =>
      Platform.OS==='ios' ? gestureState.dy > 90 && this.togglePanel() : gestureState.dy > 15 && this.togglePanel() ,
    });
    // this._childPanRespondernew = PanResponder.create({
    ...
    return (
      <Animated.View
        ...
        style={{
          ...
          borderTopRightRadius:this.state.isPanelOpened ? 0 :20,
          borderTopLeftRadius:this.state.isPanelOpened ? 0 :20,
          transform: [
