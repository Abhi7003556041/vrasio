...
const EditTextComponent = (props) => {
  ...
  return (
    ...
    {props.isLeftIconVisible?(props.leftIconPath?props.leftIconPath:<TouchableOpacity style={{paddingRight:5,justifyContent:'center'}}><EyeHide /></TouchableOpacity>):null}
    {/* <View style={{flex:1,justifyContent:'center'}}> */}
      <TextInput 
      
      style={[{color:Theme.colors.black,flex:1,textAlign:'left',marginLeft:4,fontSize:14,fontFamily:Theme.FontFamily.normal},props.textInputStyle]}
      ...
      />
    {/* </View> */}
    {props.isRightIconVisible?(props.rightIconPath?props.rightIconPath:<TouchableOpacity style={{paddingLeft:5,justifyContent:'center'}}>
      <EyeHide/>
