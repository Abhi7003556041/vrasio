...
const BecomeHostNew = (props) => {
  ...
  form.append('country_id', Number(selectedItem?.id))
  form.append('identity_type', IdNew)
...
const storeToLocalAndRedux = () => {
  // console.log('userDataa', userDataa?.data)

  setData('account', {...userDetails,host_status: "REQUEST"})

  dispatch(setUserDetails({...userDetails,host_status: "REQUEST"}))
  ...
  return (
    ...
    >
      {console.log('sdsds', IdNew.split(" ").join("").toString())}
