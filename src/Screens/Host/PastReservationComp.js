...
const PastReservationComp = (props) => {
    ...
    const PastBooking = () => {
        ...
        postApi("api/guestbookinglist", data, token).then(response => {
            console.log('responsePastBooking', response)
            if (response?.status) {
    ...
    const PastBookingRefress = () => {
        ...
        postApi("api/guestbookinglist", data, token).then(response => {
            // console.log('responsePastBooking', JSON.stringify(response))
            if (response?.status) {
                //   storeToLocalAndRedux(response)
                setrefreshing(false)
                setUpcomingData(response?.data?.data)
...
export default PastReservationComp
