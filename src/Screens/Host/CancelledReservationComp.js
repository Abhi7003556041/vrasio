...
const CancelledReservationComp = (props) => {
    ...
    const CancelledBooking = () => {
        ...
        postApi("api/guestbookinglist", data, token).then(response => {
            console.log('responseCancelledBooking', response)
            if (response?.status) {
    ...
    const CancelledBookingRefress = () => {
        ...
        postApi("api/guestbookinglist", data, token).then(response => {
            // console.log('responseCancelledBooking', JSON.stringify(response))
            if (response?.status) {
                //   storeToLocalAndRedux(response)
                setrefreshing(false)
                setUpcomingData(response?.data?.data)
...
export default CancelledReservationComp
