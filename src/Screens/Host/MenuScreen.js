...
<>
            <Pressable
            onPress={()=>{
                userDetails?.host_status ==="ACTIVE" ? switchHost() :
                NavigationService.navigate('BecomeHost')
            }}
            style={{
            ...
            >
            <Text style={{ fontSize: 14, fontFamily: Theme.FontFamily.bold, color: '#000' ,marginLeft:10}}>
                {userDetails?.host_status ==="ACTIVE" ? "Switch to Traveller" : "Become a Host"}</Text>
            ...
            {/* <Text style={{ fontSize: 13, fontFamily: Theme.FontFamily.normal, color: '#747A82' ,textAlign:'center',marginTop:5}}>Version 1.0.0 (00281566)</Text> */}
